package sample.compiler.core.lr;

import sample.compiler.ui.DataInputFiled;
...
public class LR1_Synax {
    ...
    public static void main(String []arg) throws IOException {
        ...
        list = fr.Read("src/resource/test/lr.txt");
        ...
        if(util.Judge(list)){
            ...
            util.Parser_Table();
            util.show();
            System.out.println("输入算术表达式:");
            Scanner scanner = new Scanner(System.in);
            //String s = "i+i#";
            //String s = new DataInputFiled().getInputData();
